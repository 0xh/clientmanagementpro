...
(function ($) {
    ...
    */      
    ...
    //buttons
    $.fn.editableform.buttons = '<button type="submit" class="button small-button editable-submit">ok</button>'+
    '<button type="button" class="button small-button editable-cancel">cancel</button>';      
    ...
    $.extend(Checklist.prototype, {
        renderList: function() {
            ...
            for(var i=0; i<this.sourceData.length; i++) {
                $label = $('<label class="input-control checkbox">').append($('<input>', {
                                           type: 'checkbox',
                                           value: this.sourceData[i].value 
                                     }))
                                     .append($('<span class="check">'))
                                     .append($('<span class="caption">').text(' '+this.sourceData[i].text));
