...
(function (factory) {
  ...
  var Renderer = function () {
    ...
    var tplDropdown = function (contents, className, nodeName) {
      var classes = 'dropdown-menu split-content d-menu ' + (className ? ' ' + className : '');
      var attr    = 'data-role="dropdown" ';
      nodeName = nodeName || 'ul';
      if (contents instanceof Array) {
        contents = contents.join('');
      }

      return '<' + nodeName + ' class="' + classes + '" '+ attr +' >' + contents + '</' + nodeName + '>';
    };
    ...
    var tplDialogInfo = {
      image: function (lang, options) {
        ...
        var body =  '<div class="grid" >' +
                      '<div class="row cells note-group-select-from-files">' +
                        '<div class="cell" >' +
                      ...
                      '</div>' +
                    '</div>' ;
        var footer = '<button href="#" class="button primary note-image-btn disabled" disabled>' + lang.image.insert + '</button>';
                        ...
                        '<div class="cell" >'+
                          '<div class="checkbox">' +
                            '<label class="input-control checkbox" >' + 
                              ...
                              '<span class="caption" >'+lang.link.openInNewWindow +'</span>'+
                            '</label>' +
                          '</div>' +
                        '</div>' +
                      '</div>' : ''
                   );
        var footer = '<button href="#" class="button primary note-link-btn disabled" disabled>' + lang.link.insert + '</button>';
