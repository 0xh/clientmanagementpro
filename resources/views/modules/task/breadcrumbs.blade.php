<div class="">
    <ul class="breadcrumbs fg-amber dark bg-teal" v-if="guard === 'employee'">
        ...
        <li><a href="/team/dashboard/jobs/{{ $task->id }}">@{{ taskForm.task_name }}</a></li>
    </ul>
    <ul class="breadcrumbs fg-amber dark bg-teal" v-else-if="guard === 'client'">
        ...
        <li><a href="/client/dashboard/jobs/{{ $task->id }}">@{{ taskForm.task_name }}</a></li>
    </ul>
    <ul class="breadcrumbs fg-amber dark bg-teal" v-else>
        ...
        <li><a href="/dashboard/jobs/{{ $task->id }}">@{{ taskForm.task_name }}</a></li>
    </ul>
</div>