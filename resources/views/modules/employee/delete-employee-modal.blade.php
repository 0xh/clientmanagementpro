<modal name="delete-employee-modal" :width="500" :height="300" draggable=".window-header">
        <div class="panel widget-box">
    
            <div class="heading" style="background-color:#4db6ac;">
                <div class="title window-header align-center">Confirm Teammate Deletion </div>
            </div>
        ...
        <div class="row" style="position: absolute;width: 100%;bottom:0;">
            <button @click="deleteEmployee()" type="button" class="button fg-white" style="width:500px; margin-bottom:-1px;background-color:#b71c1c;">
