<modal name="delete-subtask-modal" :width="500" :height="250" draggable=".window-header">
    ...
    <div class="row" style="position: absolute;width: 100%;bottom:0;">
        <button @click="deleteSubtask()" type="button" class="button fg-white" style="width:500px; margin-bottom:-1px;background-color:#b71c1c;">
            <strong class="icon mif-bin"> Confirm</strong>
        </button>
        <button @click="hide('delete-subtask-modal')" type="button" class="button fg-white" style="width:500px; margin-bottom:-1px;background-color:#4db6ac;">
